...
function immutableInit (config) {
  ...
  function isFileObject (obj) {
    return typeof window.File !== 'undefined' && obj instanceof window.File
  }
  ...
  assign(Immutable, {
    asMutable: toStaticObjectOrDateOrArray(asMutableObject, asMutableArray, asMutableDate),
    asObject: toStatic(asObject),
    flatMap: toStatic(flatMap),
    from: Immutable,
    getIn: toStatic(getIn),
